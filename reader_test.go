...
func NewLogDgramProducer(c int) *LogDgramProducer {
	return &LogDgramProducer{Total: c, Data: []byte("\n")}
}
...
func NewInputProducer(c int) InputProducer {
	curr := 0
	tb := 0
	return InputProducer{Total: &c, Curr: &curr, TotalBytes: &tb, Data: []byte("\n")}
}
